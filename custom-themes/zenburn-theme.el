...
;;; Commentary:
;;
;; A port of the popular Vim theme Zenburn for Emacs 24, built on top of the new
;; built-in theme support in Emacs 24. There exists one other version of the
;; theme by Daniel Brockman. My version was originally based on it, but it was
;; in such a disarray, that I decided to rewrite it from scratch in a more
;; maintainable manner (hopefully).
;;
;;; Installation:
;;
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(ac-candidate-face ((,class (:background ,zenburn-yellow :foreground ,zenburn-bg))))
   `(ac-selection-face ((,class (:background ,zenburn-orange :foreground ,zenburn-red-4))))
   ...
   `(wl-highlight-summary-disposed-face ((,class (:foreground ,zenburn-fg :slant italic))))
   ...
   `(persp-selected-face ((,class (:foreground ,zenburn-yellow :weight bold))))
   ...
   `(ahs-plugin-defalt-face ((,class (:foreground ,zenburn-fg :background ,zenburn-bg+2))))
   ...
   `(term-color-cyan ((,class (:background ,zenburn-cyan :foreground ,zenburn-cyan :weight bold))))
   `(term-color-green ((,class (:background ,zenburn-green :foreground ,zenburn-green :weight bold))))
